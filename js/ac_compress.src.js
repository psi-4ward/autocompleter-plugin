...
var Autocompleter = new Class({
	...
	build: function() {
		...
		this.element.setProperty('autocomplete', 'off')
			...
			.addEvent('focus', function(){this.toggleFocus.delay(100,this,true);}.bind(this))
			.addEvent('blur', function(){ this.toggleFocus.delay(100,this,false);}.bind(this));
	},
...
Autocompleter.Request = new Class({
	...
	query: function(){
		...
		this.request.send(Object.toQueryString(data));
	},
